...
import net.lingala.customzip4j.model.enums.CompressionLevel;
...
import static net.lingala.customzip4j.util.BitUtils.setBit;
import static net.lingala.customzip4j.util.BitUtils.unsetBit;
import static net.lingala.customzip4j.util.FileUtils.isZipEntryDirectory;
import static net.lingala.customzip4j.util.ZipVersionUtils.determineVersionMadeBy;
import static net.lingala.customzip4j.util.ZipVersionUtils.determineVersionNeededToExtract;
