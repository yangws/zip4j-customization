...
package net.lingala.customzip4j.headers;
...
import net.lingala.customzip4j.model.AESExtraDataRecord;
import net.lingala.customzip4j.model.CentralDirectory;
import net.lingala.customzip4j.model.DataDescriptor;
import net.lingala.customzip4j.model.DigitalSignature;
import net.lingala.customzip4j.model.EndOfCentralDirectoryRecord;
import net.lingala.customzip4j.model.ExtraDataRecord;
...
import net.lingala.customzip4j.model.Zip64EndOfCentralDirectoryLocator;
import net.lingala.customzip4j.model.Zip64EndOfCentralDirectoryRecord;
import net.lingala.customzip4j.model.Zip64ExtendedInfo;
import net.lingala.customzip4j.model.ZipModel;
import net.lingala.customzip4j.model.enums.AesKeyStrength;
import net.lingala.customzip4j.model.enums.AesVersion;
...
import static net.lingala.customzip4j.headers.HeaderUtil.decodeStringWithCharset;
import static net.lingala.customzip4j.util.BitUtils.isBitSet;
import static net.lingala.customzip4j.util.InternalZipConstants.ENDHDR;
import static net.lingala.customzip4j.util.InternalZipConstants.MAX_COMMENT_SIZE;
import static net.lingala.customzip4j.util.InternalZipConstants.ZIP4J_DEFAULT_CHARSET;
import static net.lingala.customzip4j.util.InternalZipConstants.ZIP_64_NUMBER_OF_ENTRIES_LIMIT;
import static net.lingala.customzip4j.util.InternalZipConstants.ZIP_64_SIZE_LIMIT;
import static net.lingala.customzip4j.util.Zip4jUtil.readFully;
