package net.lingala.customzip4j.tasks;
...
import net.lingala.customzip4j.io.outputstream.SplitOutputStream;
...
import net.lingala.customzip4j.util.BitUtils;
...
import static net.lingala.customzip4j.headers.HeaderUtil.getFileHeader;
import static net.lingala.customzip4j.model.ZipParameters.SymbolicLinkAction.INCLUDE_LINK_AND_LINKED_FILE;
import static net.lingala.customzip4j.model.ZipParameters.SymbolicLinkAction.INCLUDE_LINK_ONLY;
import static net.lingala.customzip4j.model.enums.CompressionMethod.DEFLATE;
import static net.lingala.customzip4j.model.enums.CompressionMethod.STORE;
import static net.lingala.customzip4j.model.enums.EncryptionMethod.NONE;
import static net.lingala.customzip4j.model.enums.EncryptionMethod.ZIP_STANDARD;
import static net.lingala.customzip4j.progress.ProgressMonitor.Task.ADD_ENTRY;
import static net.lingala.customzip4j.progress.ProgressMonitor.Task.CALCULATE_CRC;
import static net.lingala.customzip4j.progress.ProgressMonitor.Task.REMOVE_ENTRY;
import static net.lingala.customzip4j.util.CrcUtil.computeFileCrc;
import static net.lingala.customzip4j.util.FileUtils.assertFilesExist;
import static net.lingala.customzip4j.util.FileUtils.getRelativeFileName;
import static net.lingala.customzip4j.util.Zip4jUtil.epochToExtendedDosTime;
